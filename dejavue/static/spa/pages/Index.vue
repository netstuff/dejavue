...
const count = ref(0);
const rocketTop = computed(() => -count.value * 10 + 'px');
</script>

<template>
  <main>
    <div class="rocket" :style="{top: rocketTop}">
    ...
    <p>
      View <a href="https://docs.djangoproject.com/en/5.2/releases/" target="_blank" rel="noopener">release notes</a> for Django 5.2
    </p>
  ...
  <footer>
    <a class="option" href="https://docs.djangoproject.com/en/5.2/" target="_blank" rel="noopener">
    ...
    <a class="option" href="https://docs.djangoproject.com/en/5.2/intro/tutorial01/" target="_blank" rel="noopener">
      <svg viewBox="0 0 24 24" aria-hidden="true">
