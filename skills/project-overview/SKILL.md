...
description: General description of the Dejavue fullstack monolith project — Django 5 + Vue 3 + Inertia.js + PrimeVue + Tailwind v4, goals, and stack overview.
---

# Dejavue — Fullstack One-App Boilerplate
...
- **Modern Monolith** — один Django-проект без выделенных приложений, вся бизнес-логика в `dejavue/`.
